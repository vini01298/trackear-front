...
const ALLOWED_KEYS = [
   ...
   * e, se necessário, gera o utm_term.
   */
  function storeParamsInLocalStorage(params) {
    ...
    if (
      ...
      const domain = window.location.hostname; // ex: "www.meusite.com"
      const slug = window.location.pathname;   // ex: "/caminho/pagina.html"
      ...
      // Atualiza também a URL atual sem recarregar a página
  ...
  // 2) Armazena-os no localStorage e, se necessário, gera utm_term
